...
//                    }
    ...
    @Override
    public boolean onTouchEvent(MotionEvent ev) {           // Log.w(TAG, " - - - - -【36】 - - - - -  " );
    ...
    @Override
    public boolean onTrackballEvent(MotionEvent ev) {           // Log.w(TAG, " - - - - -【38】 - - - - -  " );
        if (isInPlaybackState() && mMediaController != null) {
            toggleMediaControlsVisibility();
        }
        return false;
    ...
    private void toggleMediaControlsVisibility() {   // Log.w(TAG, " - - - - -【41】 - - - - -  " );
    ...
    public void start() {
        ...
        if (isInPlaybackState()) {
           // Log.w(TAG, " - - - - -【43】 - - - - -  " );
            ...
            mMediaPlayer.start();
           // Log.w(TAG, "start-1---> " +mMediaPlayer.getCurrentPosition());
            mCurrentState = STATE_PLAYING;
            if (this.videoViewCallback != null) {
                this.videoViewCallback.onStart(mMediaPlayer);
               // Log.w(TAG, "start-2---> " +mMediaPlayer.getCurrentPosition());
            }
        }
    ...
    @Override
    public int getDuration() {   // Log.w(TAG, " - - - - -【47】 - - - - -  " );
        if (isInPlaybackState()) {
    ...
    @Override
    public void seekTo(int msec) {   // Log.w(TAG, " - - - - -【49】 - - - - -  " );
        if (isInPlaybackState()) {
    ...
    @Override
    public boolean isPlaying() {   // Log.w(TAG, " - - - - -【50】 - - - - -  " );
        return isInPlaybackState() && mMediaPlayer.isPlaying();
    }

    @Override
    public int getBufferPercentage() {  // Log.w(TAG, " - - - - -【51】 - - - - -  " );
        if (mMediaPlayer != null) {
    ...
    private boolean isInPlaybackState() {  // Log.w(TAG, " - - - - -【52】 - - - - -  " );
    ...
    @Override
    public void setFullscreen(boolean fullscreen) {  // Log.w(TAG, " - - - - -【53】 - - - - -  " );
    ...
    @Override
    public void setFullscreen(boolean fullscreen, int screenOrientation) {  // Log.w(TAG, " - - - - -【54】 - - - - -  " );
...
//        void onReStart(boolean isFullscreen);//我额外添加的
    ...
    public void setVideoViewCallback(VideoViewCallback callback) {  // Log.w(TAG, " - - - - -【55】 - - - - -  " );
